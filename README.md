...
Скриншот с деплоем артефакта  
![terraform 1](https://github.com/ANDREYTOLOGY/terraform-hw/blob/main/img/teamcity4.png)  

Скриншот с различными версиями артефактов, после автоматического запуска bild при измненениях  
![terraform 1](https://github.com/ANDREYTOLOGY/terraform-hw/blob/main/img/teamcity5.png) 
